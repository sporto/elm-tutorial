...
To deal with circular dependencies in Elm the easiest thing to do is to break your application in smaller modules, with smaller modules for things like __actions__, __models__, __effects__ and __utilities__ which are modules that are usually imported by many components.
